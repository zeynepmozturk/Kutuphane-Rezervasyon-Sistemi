...
if ($_SERVER["REQUEST_METHOD"] === "POST") 
{
    ...
    else if (!filter_var($_POST["yeni_email"], FILTER_VALIDATE_EMAIL))//https://www.w3schools.com/php/php_form_url_email.asp bu siteden hazır olarak aldım bu bloğu
    {
    ...
    else if(empty($_POST["yeni_parolatkr"]))
    {
        $parolatkr_err = "Parola tekrar alanı boş geçilemez.";
    } 
        ...
        $parolatkr=password_hash($_POST["yeni_parolatkr"], PASSWORD_DEFAULT);
    }
